...
<div class="wrap bsi-wrap">
	...
	<?php if ( ! $session ) : ?>
		...
		<div class="bsi-card" style="max-width:500px;">
			<h3><?php esc_html_e( 'Что в опасной зоне?', 'beestore-integration' ); ?></h3>
			<ul style="list-style:disc;padding-left:20px;">
				<li><strong style="color:#d63638;"><?php esc_html_e( 'Удаление всех картинок BeeStore', 'beestore-integration' ); ?></strong> — <?php esc_html_e( 'полная очистка Media Library от картинок плагина', 'beestore-integration' ); ?></li>
				<li><strong style="color:#d63636;"><?php esc_html_e( 'Удаление дублей картинок', 'beestore-integration' ); ?></strong> — <?php esc_html_e( 'оставляет по одной каждого изображения', 'beestore-integration' ); ?></li>
				<li><strong style="color:#d63638;"><?php esc_html_e( 'Очистка диска от дублей файлов', 'beestore-integration' ); ?></strong> — <?php esc_html_e( 'удаление файлов с суффиксами -1, -2, -3', 'beestore-integration' ); ?></li>
				<li><strong style="color:#d63628;"><?php esc_html_e( 'Удаление orphan миниатюр', 'beestore-integration' ); ?></strong> — <?php esc_html_e( 'миниатюры с незарегистрированными размерами', 'beestore-integration' ); ?></li>
				<li><strong><?php esc_html_e( 'Смена пароля', 'beestore-integration' ); ?></strong></li>
			</ul>
		</div>
	...
	<?php else : ?>
		...
		<!-- ═══ 1. УДАЛЕНИЕ ВСЕХ КАРТИНОК BEESTORE ═══ -->
